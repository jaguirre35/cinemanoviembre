...
estrenos.forEach(function(estreno){
    ...
    sinopsis2.textContent=estreno.sinopsis
...
etiquetaFila2.addEventListener("click",function(evento2){
    if(evento2.target.classList.contains("img-fluid")){
       ...
       peliculaSeleccionada2.imagen2=evento2.target.parentElement.querySelector("img").src
       peliculaSeleccionada2.titulo2=evento2.target.parentElement.querySelector("h3").textContent
       peliculaSeleccionada2.descripcion2=evento2.target.parentElement.querySelector("h5").textContent
       peliculaSeleccionada2.sinopsis2=evento2.target.parentElement.querySelector("p").textContent

       //console.log(peliculaSeleccionada)
       //Enviando nuestros datos de la pelicula seleccionada a la memoria
       localStorage.setItem("estreno",JSON.stringify(peliculaSeleccionada2))
